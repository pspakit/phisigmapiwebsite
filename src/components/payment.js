      ...
      <div>
        ...
        <section className="container">
          <p className="has-text-centered">
            Our chapter has decided to use the payment processing platform
            Stripe to collect both <b>initiate</b> and <b>sibling</b> dues this
            semester!
          </p>
        </section>
        ...
        <section className="another-container has-text-centered">
          <p>
            If you are an initiate, use the <b>initiate payment link</b> found
            below
          </p>
        </section>
        ...
        <section className="link-container">
          <h4 className="has-text-centered">
            <a
              href="https://buy.stripe.com/4gwaIJ7yG7Migww7st"
              target="_blank"
              rel="noreferrer"
            >
        ...
        <section className="another-container has-text-centered">
          <p>
            If you are a sibling, use the <b>sibling payment link</b> found
            below
          </p>
        </section>
        ...
        <section className="link-container">
          <h4 className="has-text-centered">
            <a
              href="https://buy.stripe.com/fZe4klf183w20xy14E"
              target="_blank"
              rel="noreferrer"
            >
              Sibling Payment Link
            </a>
          </h4>
        </section>
        ...
        <section className="special-qualification-container">
          <p className="has-text-centered">
            Once you have navigated to the appropriate stripe page...
          </p>
        </section>
        ...
        <div className="mission-row2">
          <div className="mission-col2">
            <img
              src="pictures/pspak_dues_initiates.jpg"
              alt="Initiate Dues"
            ></img>
          </div>
          <div className="mission-col2">
        ...
        <div className="mission-row2">
          <div className="mission-col2">
            <img
              src="pictures/initiate_dues_full.jpg"
              alt="Initiate Dues"
            ></img>
          </div>
          <div className="mission-col2">
